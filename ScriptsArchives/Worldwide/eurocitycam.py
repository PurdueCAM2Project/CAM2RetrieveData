...
"""
-----------------------------------------------------------------------------
Descriptive Name: eurocitycam.py
Author          : (rewritten by Chan Weng Yan)					      
Contact Info    : cwengyan@purdue.edu
Date Written    : June 23,2016
Description     : Parse several european non traffic cameras
Command to run  : python eurocitycam.py > eurocamError
script
Output          : country#city#snapshot_url#latitude#longitude to 
		  <list_eurocitycam.txt>
		  urls that raise errors will be redirected to <eurocamError>
Note            : 1) this website uses a lot of non-ascii (unicode) characters.
		     ...
		     to <eurocamError> and fix manually
...
In database (Y/N)    : Y
Date added to Database : June 24, 2016
----------------------------------------------------------------------------
"""
